...
\begin{itemize}
    ...
    \item aggiunge una variabile per ogni generatore di corrente: la tensione ai suoi capi;
    \item scrive le equazioni di maglia includendo queste tensioni incognite;
    \item aggiunge un’equazione di vincolo per ogni generatore.
\end{itemize}


\subsection*{Esempio applicativo}

Applichiamo la procedura al circuito di Figura \ref{fig:circuito_3}, che contiene tre maglie e due generatori di corrente.
