...
\begin{itemize}
    \item Per la \textbf{prima maglia} notiamo che il resistore $R_1$ appartiene solo alla prima maglia, mentre il resistore $R_3$ è condiviso tra la prima e la seconda maglia. Perciò l'equazione diventa:
...
\item Per la \textbf{seconda maglia} notiamo che il resistore $R_2$ appartiene solo alla seconda maglia, mentre i resistori $R_3$ e $R_4$ sono rispettivamente condivisi con la prima e con la terza maglia. Perciò l'equazione diventa:
...
\item Per la \textbf{terza maglia} notiamo che il resistore $R_5$ appartiene solo alla terza maglia, mentre il resistore $R_4$ è condiviso tra la terza e la seconda maglia. Perciò l'equazione diventa:
\begin{equation}
...
Riorganizzando i termini, possiamo riscrivere il sistema in questa maniera:
