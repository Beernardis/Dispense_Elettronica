...
Definiamo anche la \textbf{maglia elementare} come una maglia che non presenta sottomaglie.\\
...
Per esprimere le tensioni sui resistori si utilizza la \textbf{legge di Ohm}, che lega tensione, corrente e resistenza:
...
Un aspetto particolarmente importante riguarda le \textbf{resistenze condivise tra due maglie}. In questo caso, la corrente che attraversa la resistenza non è una sola corrente di maglia, ma la somma o la differenza tra le correnti associate alle due maglie adiacenti. \\

Se, ad esempio, una resistenza è attraversata dalle correnti di maglia $I_1$ e $I_2$, la corrente effettiva nel ramo si può esprimere come:
